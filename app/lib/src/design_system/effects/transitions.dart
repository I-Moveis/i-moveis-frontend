...
class CurtainTransition extends PageRouteBuilder {
  final Widget page;
...
class _CurtainTransitionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final coverProgress = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: animation,
        curve: const Interval(0.0, 0.5, curve: Curves.easeInQuart),
      ),
    );
    final revealProgress = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: animation,
  ...
  Widget _buildCurtain(BuildContext context, double cover, double reveal) {
    ...
    double left = 0, top = 0, right = w, bottom = h;
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      ...
                      widget.foregroundColor.withValues(alpha: 0.0),
                    ],
                  ),
                ),
              ),
...
class CircleReveal extends PageRouteBuilder {
  final Widget page;
  final Offset? origin;
  final Duration animationDuration;
...
class SliceTransition extends PageRouteBuilder {
  final Widget page;
...
class _SliceTransitionWidget extends StatelessWidget {
  ...
  Widget _buildSlice(BuildContext context, int index) {
    ...
    final sliceAnim = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: animation,
