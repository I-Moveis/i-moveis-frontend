                          ...
                          showAppBottomSheet(
                            ...
                            builder: (ctx) => Padding(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  const AppBottomSheetHeader(title: 'Search'),
                                  const SizedBox(height: AppSpacing.lg),
                                  const AppSearchBar(
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: AppSpacing.md),
                          AppAvatar(size: AppAvatarSize.md, initials: 'MD'),
                          SizedBox(width: AppSpacing.md),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppImageCard(
                        ...
                        subtitle: 'Florianópolis • R\$ 250/night',
                        badge: 'Novo',
                    ...
                    children: [
                      ...
                      _TransitionButton(
                        ...
                        onTap: () => Navigator.of(context).push(
                          CurtainTransition(
                            page: _TransitionDemoPage(name: 'Curtain'),
                          ),
                        ),
                      ),
                      const SizedBox(height: AppSpacing.sm),
